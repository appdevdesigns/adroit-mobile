...
import activityListStyles, { imageWrapperStyle, imageWrapperSize, teamFontSize, activityFontSize } from '../style';
...
const PlaceholderListItem = () => (
  <View style={activityListStyles.listItem}>
    <Left style={activityListStyles.left}>
      <Placeholder.Media size={imageWrapperSize} style={imageWrapperStyle} animate={animate} />
    </Left>
